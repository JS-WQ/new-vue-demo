    ...
    <div id="topbar">
        <div class="topNav">
            ...
            <div class="actions">
                ...
                <section :visible="signUpVisi" @close="signUpVisi = false">
                    <signUp />
                </section>
                <a class="button" href="#" @click.prevent="signUpVisi = true">登录</a>
                <section :visible="loginVisi" @close="loginVisi = false">
                    <login />
                </section>
                <el-button type="primary" round @click="preview">预览</el-button>
                <el-button type="primary" round @click="preview">保存</el-button>                
            </div>
        </div>
