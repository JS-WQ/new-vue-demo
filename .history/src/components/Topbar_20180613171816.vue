            ...
            <div class="actions">
                ...
                <div v-else class="userActions">
                    ...
                    <loginSignBox :visible="loginVisi" @close="loginVisi = false">
                        <login @success="login($event)" v-bind:loginVisi="loginVisi" v-bind:iresum="iresum"/>
                    </loginSignBox>
                </div>
...
export default {
    ...
    methods:{
        ...
        ResumFolder:function(){
            ...
            //var newtest={name: 'langlang',birth: '',worktime:'ruanjiankaifa',dreamPosition:'',expectedSalary:'',Blog:'',Github:'',city: ''}
            irusmer.setACL(acl)
