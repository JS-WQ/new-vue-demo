<template>
    <div id="topbar">
        <div class="topNav">
            ...
            <div class="actions">
                <el-button type="primary" round value="signUp" v-model="actionType">注册:{{v-model}}</el-button>
                <el-button type="primary" round value="login" v-model="actionType">登陆</el-button>
