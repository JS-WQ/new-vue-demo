    ...
    <div id="topbar">
        <div class="topNav">
            ...
            <div class="actions">
                ...
                <el-button type="radio" round v-bind:value="signUp" v-model="actionType" >注册</el-button>
                <el-button type="radio" round v-bind:value="login" v-model="actionType"  >登陆</el-button>
