...
export default {
    ...
    methods:{
        ...
        ResumFolder:function(){
            ...
            irusmer.setACL(acl)
            console.log(typeof this.iresum.callme)
            console.log(typeof this.iresum.itemsdemo)

            //this.iresum.map(irusmer.set)
            //console.log(typeof this.iresum)
            for(var key in this.iresum){
                //irusmer.set(typeofthis.iresum[key])
                console.log(typeof this.iresum)
            }
