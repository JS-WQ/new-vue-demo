...
export default {
    ...
    methods:{
        ...
        offshow(){
            document.querySelector('#Edonshow').setAttribute('id','Edonshow')
            document.querySelector('#TBonshow').setAttribute('id','topbar')
            document.querySelector('#PWonshow').setAttribute('id','')
        }
    },
    created:function(){
