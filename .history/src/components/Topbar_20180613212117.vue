<template>
    <div id="topbar">
        <div class="topNav">
            ...
            <div class="actions">
                <div v-if="inlogined" class="userActions" @changedata='changedata'>
                ...
                <div v-else class="userActions">
                    <el-button type="primary" round @click.prevent="signUpVisi = true">注册</el-button> 
                    <loginSignBox :visible="signUpVisi" @close="signUpVisi = false">
                        <signUp @success="login($event)" v-bind:signUpVisi="signUpVisi"/>
                    </loginSignBox>
                    <el-button type="primary" round @click.prevent="loginVisi = true">登录</el-button> 
                    <loginSignBox :visible="loginVisi" @close="loginVisi = false">
                        <login @success="login($event)" v-bind:loginVisi="loginVisi" v-bind:iresum="iresum" v-bind:inlogined="inlogined" v-bind:username="username" @changedata="changedata"/>
                    </loginSignBox>
                </div>
            </div>
        </div>
